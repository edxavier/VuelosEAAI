...
public class FlightsHelper {
    ...
    public static TextView setStatusText(Context context, TextView textView, String status){
        ...
        if(status.equals("Cancelado")) {
            ...
            statusText.setTextColor(context.getResources().getColor(R.color.md_purple_500));
            ...
            statusText.setTextColor(context.getResources().getColor(R.color.md_cyan_500));
            ...
            statusText.setTextColor(context.getResources().getColor(R.color.md_teal_500));
        }
        else {
            statusText.setTextColor(context.getResources().getColor(R.color.md_black_1000_50));
