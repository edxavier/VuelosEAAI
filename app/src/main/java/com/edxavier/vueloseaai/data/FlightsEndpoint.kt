...
sealed class FlightsEndpoint(var endpointUrl:String){
    object NatArrivals:FlightsEndpoint("$BASE_URL/pvnac/read_vuelos_dias_pvnac.php?option=A")
    object NatDepartures:FlightsEndpoint("$BASE_URL/pvnac/read_vuelos_dias_pvnac.php?option=D")
