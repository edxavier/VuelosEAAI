...
sealed class FlightsEndpoint(var endpointUrl:String){
    ...
    object IntArrivals:FlightsEndpoint("$BASE_URL/fids/vuelos_dias_fids.php?option=A")
    object IntDepartures:FlightsEndpoint("$BASE_URL/fids/vuelos_dias_fids.php?option=D")
}