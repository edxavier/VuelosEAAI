 ...
 */
public class AsynLLegadasNacionales extends AsyncTask<Void, Void, Void> {

    @Override
    protected Void doInBackground(Void... params) {
        ArrayList<Vuelo> vuelos = new ArrayList<Vuelo>();
        try{
            Document doc = Jsoup.connect("http://www.eaai.com.ni/vuelos/solovuelosn.php").get();
            ...
            //Log.d("EDER_LLEGADA_NAC",e.getMessage());
        }
        return null;
    }
}
