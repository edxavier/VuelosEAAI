 ...
 */
public class AsynSalidasInternacionales extends AsyncTask<Void, Void, Void> {

    @Override
    protected Void doInBackground(Void... params) {
        ArrayList<Vuelo> vuelos = new ArrayList<Vuelo>();
        try{
            Document doc = Jsoup.connect("http://www.eaai.com.ni/vuelos/solovuelos.php?tipo=S").get();
            ...
            //Log.d("EDER_SAL_INT",e.getMessage());
        }
        return null;
    }
}
